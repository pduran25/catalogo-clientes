...
export default function CargarDatos2(props) {
    ...
    const {signInfree} = React.useContext(AuthContext);
    let db = null;
    ...
    const getDataUser = async () => {
        ...
        setUsuario(true);
        console.log(dataUser.cl_cliente);
        } catch(e) {
       // console.log(e)
        }
    }
        ...
        const createTable = async() => {
          ...
          getCatalogos = async () => {
            try {
              ...
              const response2 = await fetch(
                "https://app.cotzul.com/Catalogo/php/conect/db_getCatalogosxidcliente.php?id="+dataUser.cl_codigo
              );
              console.log("https://app.cotzul.com/Catalogo/php/conect/db_getCatalogosxidcliente.php?id="+dataUser.cl_codigo);
          ...
          getClientes = async () => {
            try {
              ...
              setActCLI(2);
              const response2 = await fetch(
                "https://app.cotzul.com/Catalogo/php/conect/db_getClientexidvendedor.php?id="+dataUser.cl_codvendedor
              );
              console.log("https://app.cotzul.com/Catalogo/php/conect/db_getClientexidvendedor.php?id="+dataUser.cl_codvendedor);
              const jsonResponse2 = await response2.json();
          ...
          saveClientes = async (myResponse) => {
            ...
            getProductosxcatalogos = async () => {
              try {
                ...
                setActCAT(2);
                const response = await fetch(
                  "https://app.cotzul.com/Catalogo/php/conect/db_getProductosxcatalogo.php?id="+dataUser.cl_codvendedor
                );
                const jsonResponse = await response.json();
